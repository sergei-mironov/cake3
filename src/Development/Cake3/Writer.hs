...
instance ToMakeText (FileT FilePath) where
...
instance ToMakeText (Command (FileT FilePath)) where
...
toMake :: ([Variable], [Recipe3]) -> String
toMake (vs,rs) = ls $ flip execState (WS [1..] "") $ do
